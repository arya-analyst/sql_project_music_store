...
-- Return the Name, time duration for each track. Order by the song length with the longest songs listed first.
...
-- Q8. We want to find out the most popular music genre for each country. We determine the most popular genre with the highest amount of purchases.
...
-- Write a query that returns the country along with the customer snd how much do they spent
